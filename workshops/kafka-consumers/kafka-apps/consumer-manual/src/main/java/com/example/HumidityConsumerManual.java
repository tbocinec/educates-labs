...
public class HumidityConsumerManual {
    ...
    public static void main(String[] args) {
        System.out.println("📖 Starting Manual Commit Humidity Consumer...");
        System.out.println("📊 Consumer Group: " + GROUP_ID);
        System.out.println("✋ Using MANUAL COMMIT mode");
        System.out.println("🎯 Guarantees: AT-LEAST-ONCE delivery\n");
